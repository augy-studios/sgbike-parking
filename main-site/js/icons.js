// Inline SVG icon registry. No emoji anywhere in the UI.
// Theme icons follow the spec convention: viewBox "0 0 24 24", no intrinsic
// size, stroke="currentColor", stroke-width 1.8, round caps and joins.
// App icons keep their original 1em sizing so existing layouts do not shift.
...
const ICONS = {
  ...
  // ---- favourites and sync ----
  // star is the unsaved outline, starFilled is the saved state. The fill is
  // driven by CSS so the yellow follows the current mode.
  star: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m12 2.6 2.9 5.88 6.49.95-4.7 4.58 1.11 6.46L12 17.42l-5.8 3.05 1.1-6.46-4.69-4.58 6.49-.95Z"/></svg>`,
  starFilled: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m12 2.6 2.9 5.88 6.49.95-4.7 4.58 1.11 6.46L12 17.42l-5.8 3.05 1.1-6.46-4.69-4.58 6.49-.95Z"/></svg>`,
  ...
  check: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>`,
  copy: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>`,
  telegram: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" stroke="none" aria-hidden="true"><path d="M21.94 4.3a1.2 1.2 0 0 0-1.6-1.14L2.7 9.9c-1 .38-.98 1.8.02 2.16l4.4 1.56 1.7 5.36a1.05 1.05 0 0 0 1.78.4l2.4-2.5 4.5 3.3a1.2 1.2 0 0 0 1.88-.72Zm-3.3 3-7.6 6.72a1 1 0 0 0-.32.6l-.33 2.28-1.2-3.8 9-5.5a.3.3 0 0 1 .36.48Z"/></svg>`,
};
